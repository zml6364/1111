 ...
 * 用户管理界面业务逻辑
 */
public class MulUserManagerActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_back)
            ...
            {
                CommonUtils.showDlgMsg(MulUserManagerActivity3.this, "最后一页");
            } else {
                next();
            }
        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                mainHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(MulUserManagerActivity3.this, MulUserManagerActivity4.class);
